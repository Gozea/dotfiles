...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "Return", function() awful.spawn.easy_async_with_shell(
	      ...
	      {description = "open a terminal with /tmp path", group = "launcher"}),
    ...
    awful.key({ modkey }, "e", function() awful.spawn.with_shell("nautilus") end,
              {description = "launch the file manager", group = "launcher"}),
    -- Menubar
